...
class CacheStatusTest {
    ...
    @Test
    void constructor_ShouldCreateCacheStatus_WithProvidedValues() {
    ...
    @Test
    void isAvailable_ShouldReturnTrue_WhenStatusIsAvailable() {
        CacheStatus status = CacheStatus.of(100L, 80L, 20L, "AVAILABLE");
    ...
    @Test
    void isAvailable_ShouldReturnFalse_WhenStatusIsNull() {
